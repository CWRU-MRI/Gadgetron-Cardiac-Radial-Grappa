/** \file   GrappaCombinedCoilCompressionGadget_Calibration.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSMRICORE GrappaCombinedCoilCompressionGadget_Calibration : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GrappaCombinedCoilCompressionGadget_Calibration);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GrappaCombinedCoilCompressionGadget_Calibration();
        ~GrappaCombinedCoilCompressionGadget_Calibration();

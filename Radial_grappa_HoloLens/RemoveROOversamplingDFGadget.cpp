#include "RemoveROOversamplingDFGadget.h"
#include "hoNDFFT.h"
...
namespace Gadgetron{
    ...
    RemoveROOversamplingDFGadget::RemoveROOversamplingDFGadget()
    {
    ...
    int RemoveROOversamplingDFGadget::process_config(ACE_Message_Block* mb)
    {
	...
	ISMRMRD::EncodingSpace r_space = h.encoding[0].reconSpace;
        ...
        GDEBUG_STREAM("RemoveROOversamplingDFGadget:omp_set_num_threads(1) ... ");
#endif // USE_OMP
    ...
    int RemoveROOversamplingDFGadget
        ::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader>* m1,
        GadgetContainerMessage< hoNDArray< std::complex<float> > >* m2)
    {
    if (perform_timing.value()) { gt_timer_.start("RemoveROOversamplingDFGadget::process"); }
      ...
      {
	GERROR("RemoveROOversamplingDFGadget::process, passing data on to next gadget");
	return GADGET_FAIL;
      }
    ...
    GADGET_FACTORY_DECLARE(RemoveROOversamplingDFGadget)
}

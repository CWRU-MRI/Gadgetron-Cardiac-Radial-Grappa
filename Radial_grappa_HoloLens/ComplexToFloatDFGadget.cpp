...
#include "ComplexToFloatDFGadget.h"
#include "hoNDArray_elemwise.h"

namespace Gadgetron
{
    ComplexToFloatDFGadget::ComplexToFloatDFGadget()
    {
    ...
    int ComplexToFloatDFGadget::process(GadgetContainerMessage<ISMRMRD::ImageHeader>* m1, GadgetContainerMessage< hoNDArray< ValueType > >* m2)
    {
    	if (perform_timing.value()) { gt_timer_.start("ComplexToFloatDFGadget::process"); }
        ...
        {
            GEXCEPTION(err,"Unable to create float storage in ComplexToFloatDFGadget");
            return GADGET_FAIL;
        }
    ...
    GADGET_FACTORY_DECLARE(ComplexToFloatDFGadget)
}
